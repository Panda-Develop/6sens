...
<html lang="fr" dir="ltr">
  <head>
    ...
    <title>6ème Sens By Trill$hit | Musiques</title>
    ...
    <section class="main-content" style="margin-top:20vh;">
      ...
      <section class="musique-article-section">
        ...
        <div class="row">
          <?php
          include ("./cockpit/config.php");
          $request2 = "SELECT a.*, c.name, u.pseudo  from article a join category c on a.id_category = c.id_category join user u on a.id_user = u.id_user where c.name = 'musique' order by id_article desc";
