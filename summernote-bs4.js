...
var codable = renderer.create('<textarea class="note-codable" name="text" />');
...
var VideoDialog = /** @class */ (function () {
    ...
    VideoDialog.prototype.initialize = function () {
        ...
        var body = [
            ...
            '<input class="note-video-url form-control note-form-control note-input" type="text" name="video_url"/>',
            '</div>'
        ].join('');
